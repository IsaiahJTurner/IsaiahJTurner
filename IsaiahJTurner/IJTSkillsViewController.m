...
- (IBAction)securityResearch:(id)sender {
    ...
    PXAlertView *alert = [PXAlertView showAlertWithTitle:@"Security Enthusiast"
                                                 message:@"I love voiding the hell out of my Apple Care Plus warranty and enjoy jailbreaking my device! But I don't want to be a jailbreak n00b that pirates things. I hate pirates! Instead, I focus on encryption as well as security research and implementation in iOS."
